...
public class PanelBotones extends JPanel implements ActionListener
{
	...
	public PanelBotones(InterfazLibreria interfazLibreria)
	{
		...
		agregarBoton(RENOMBRAR_CATEGORIA,"Renombrar categor�as","./data/iconos/menu.png");
		agregarBoton(ELIMINAR_LIBROS, "Eliminar libros", "./data/iconos/libroeliminar.png");
	}
